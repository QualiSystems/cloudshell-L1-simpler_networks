...
sniConnToLookOutTapPort = MibTableColumn((1, 3, 6, 1, 4, 1, 4987, 1, 1, 1, 6), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 4))).setMaxAccess("readcreate")
...
sniConnToLookInTapPort = MibTableColumn((1, 3, 6, 1, 4, 1, 4987, 1, 1, 1, 7), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 4))).setMaxAccess("readcreate")
