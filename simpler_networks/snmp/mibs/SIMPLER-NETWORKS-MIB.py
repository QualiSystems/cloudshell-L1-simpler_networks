...
sniEntityShelfIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 4987, 1, 47, 2, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 9))).setMaxAccess("readonly")
...
sniEntityCardShelfIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 4987, 1, 47, 3, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 9))).setMaxAccess("readonly")
