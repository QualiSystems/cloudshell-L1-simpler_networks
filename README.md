...
### **Simpler Networks L1 Shell**
The Simpler Networks L1 shell provides you with the capability to communicate with network topology managed by the Simpler Networks switch.
...
### Standard version
The Simpler Networks L1 shell is based on the [**Layer 1 Switch Shell Standard**](https://github.com/QualiSystems/shell-L1-template).

### Requirements

Release: **Simpler Networks L1 Shell**
...
#### **Simpler Networks Families and Models**

The L1 switch families and models are listed in the following table:

|Family|Model|Description|
|:---|:---|:---|
|L1 Switch|Simpler Networks Chassis|L1 Switch Chassis|
|L1 Switch Blade|Generic L1 Module|Generic L1 Module|
|L1 Switch Port|Generic L1 Port|Generic L1 Port|

#### **Simpler Networks Attributes**

The Simpler Networks Chassis attribute names and types are listed in the following table:
...
The **Simpler Networks** L1 shell is available from the [Quali Community Integrations](https://community.quali.com/integrations) page. 

The shell comprises:

|File name|Description|
|:---|:---|
|cloudshell-L1-simpler_networks-x.x.x.zip|Simpler Networks L1 shell package|
|install_driver.bat|Simpler Networks L1 shell installation script|
|simpler_networks_runtime_config.yml|Simpler Networks L1 shell configuration file|
|simpler_networks_ResourceConfiguration.xml|XML file containing the resource structure, attributes and capabilities of the L1 switches of the same vendor|
...
**To import and configure the shell in CloudShell:**
  ...
  2. Extract the *Simpler Networks L1 shell zip* package to the following location on the Quali Server machine: 
  *C:\Program Files (x86)\QualiSystems\CloudShell\Server\Drivers*
  
  3. Run the *C:\Program Files (x86)\QualiSystems\CloudShell\Server\Drivers\cloudshell-L1-simpler_networks\install_driver.bat* file.
  
  4. Import the new data model.
      1. In **Resource Manager Client>Admin**, right-click **Resource Families** and select **Import**.
      2. Select the *C:\Program Files (x86)\QualiSystems\CloudShell\Server\Drivers\cloudshell-L1-simpler_networks\datamodel\simpler_networks_ResourceConfiguration.xml* file.
      3. Click **Open**.
  ...
  5. Create an L1 resource.
      ...
      4. Ensure that the correct **Model** Simpler Networks Chassis and **Driver** SIMPLER NETWORKS are selected.
      5. Click **OK**.
...
The *install_driver.bat* script creates a virtual environment on the Quali Server machine under *C:\Program Files (x86)\QualiSystems\CloudShell\Server\Drivers\cloudshell-L1-simpler_networks* and installs the required dependencies in this virtual environment from the extracted L1 shell folder (under *~cloudshell-L1-simpler_networks\packages*).
...
5. Copy the upgraded shell's datamodel file from:
	...
	*C:\Program Files (x86)\QualiSystems\CloudShell\Server\Drivers\cloudshell-L1-simpler_networks\datamodel\simpler_networks_ResourceConfiguration.xml*
...
For release updates, see the shell's [GitHub releases page](https://github.com/QualiSystems/cloudshell-L1-simpler_networks/releases).
